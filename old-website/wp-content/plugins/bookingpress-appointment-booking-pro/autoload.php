...
if( file_exists( BOOKINGPRESS_PRO_WIDGET_DIR . '/bookingpress-pro-elementor-widget/bookingpress-elementor-widget.php' ) ){
    include_once BOOKINGPRESS_PRO_WIDGET_DIR . '/bookingpress-pro-elementor-widget/bookingpress-elementor-widget.php';
}
...
$bookingpress_pro_version = '5.1.1';
...
if( class_exists( 'BookingPress_Core')  ){
	...
	if($bookingpress_pro_version >= "5.1"){
		if ( file_exists( BOOKINGPRESS_PRO_CLASSES_DIR . '/frontend/class.bookingpress_front_booking_form_popup.php' ) ) {
			require_once BOOKINGPRESS_PRO_CLASSES_DIR . '/frontend/class.bookingpress_front_booking_form_popup.php';
		}
	}
