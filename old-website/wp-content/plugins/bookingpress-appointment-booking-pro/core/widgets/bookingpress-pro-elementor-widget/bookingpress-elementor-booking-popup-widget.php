...
class BookingPress_Elementor_Booking_Popup_Widget extends \Elementor\Widget_Base{

    public function get_name(){
        return 'BookingPress_Elementor_Booking_Popup_Widget';
    }

    public function get_title(){
        return esc_html__('Booking Forms Popup - BookingPress', 'bookingpress-appointment-booking') . '<style>
    ...
    protected function render() {
        ...
        if( !empty($bpa_service_ids)) {
            echo '[bookingpress_form_popup service='.esc_attr($bpa_service_ids).']';
        } else {
            echo '[bookingpress_form_popup]';
        }
