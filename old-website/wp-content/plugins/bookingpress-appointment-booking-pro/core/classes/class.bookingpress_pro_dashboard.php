...
if ( ! class_exists( 'bookingpress_pro_dashboard' ) ) {
	class bookingpress_pro_dashboard Extends BookingPress_Core {
		...
		function bookingpress_modify_dashboard_data_fields_func( $bookingpress_dashboard_vue_data_fields ) {
			...
			$bookingpress_dashboard_vue_data_fields['appointment_formdata']['bpa_fileupload_max_limit_reach_msg'] = !empty( $bpa_file_upload_max_limit_msg ) ? stripslashes_deep( $bpa_file_upload_max_limit_msg ) : __("You've reached the maximum file limit", 'bookingpress-appointment-booking');
			...
			$bookingpress_dashboard_vue_data_fields['bpa_multi_appoitnment_coupon_apply_disabled'] = 0;
			...
			/* admin note */
			$bookingpress_dashboard_vue_data_fields['note_confirm_modal'] = false;
			$bookingpress_dashboard_vue_data_fields['admin_note_confirm_form']['bookingpress_add_admin_note'] = '';
			$bookingpress_dashboard_vue_data_fields['is_admin_note_btn_disabled'] = false;
			$bookingpress_dashboard_vue_data_fields['is_display_admin_note_loader'] = '0';
			$bookingpress_dashboard_vue_data_fields['rules_admin_note_confirm_form'] = array();
