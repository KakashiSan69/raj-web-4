<?php
	...
	$bookingpress_revenue_filter_payment_gateway_list = array(
		...
		array(
			'value' => 'manual',
			'text' => esc_html__('Manual( Booked by admin )', 'bookingpress-appointment-booking')
		),
		array(
			'value' => 'paypal',
			'text' => 'Paypal'
											...
											<el-row type="flex" :gutter="24">
												<el-col :xs="service_col_width.xs" :sm="service_col_width.sm" :md="service_col_width.md" :lg="service_col_width.lg" :xl="service_col_width.xl">
													<el-select class="bpa-form-control" v-model="appointment_search_service" multiple filterable collapse-tags 
														...
														:popper-append-to-body="false" popper-class="bpa-el-select--is-with-navbar" @change="change_appointment_report_filter(true)">
											...
											<el-col>
												<el-container class="bpa-table-container">
													<el-table ref="multipleTable" :data="revenue_items" class="bpa-manage-payment-items">
														...
														<el-table-column prop="staff_member_name" min-width="100" label="<?php echo esc_html($bookingpress_singular_staffmember_name); ?>" sortable v-if="(is_staffmember_activated == 1 && typeof is_multi_staffmember_activated == 'undefined')"></el-table-column>
														<?php do_action('bookingpress_after_staff_members_column', $bookingpress_singular_staffmember_name); ?>
