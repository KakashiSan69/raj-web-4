                        ...
                        <el-row type="flex">
                            <el-col :xs="4" :sm="4" :md="4" :lg="4" :xl="4">
                                <div class="bpa-customize-step-side-panel">
                                            ...
                                            <el-row type="flex" class="bpa-customize-lp-field"> 
                                                <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">													
                                                    ...
                                                    <div class="bpa-customize-form-sequence__items">
                                                        <draggable :list="booking_form_sequence" class="list-group" ghost-class="ghost" @choose="bpa_draggable_start($event)" @start="dragging = true" @end="updateSequencePos($event)" :move="bpa_draggable_steps" >
                                                            <div class="bpa-cfs__item-card" v-for="(form_sequence, key) in booking_form_settings.bookingpress_form_sequance" :data-form_sequence="form_sequence" v-if="( typeof booking_form_settings.bpa_sequence_item_visibility == 'undefined' || ( 'undefined' != typeof booking_form_settings.bpa_sequence_item_visibility && 'undefined' != typeof booking_form_settings.bpa_sequence_item_visibility[form_sequence] && true == booking_form_settings.bpa_sequence_item_visibility[form_sequence] ))">
                                                                <div class="bpa-cfs__body" >
                                                                    ...
                                                                    <div class="bpa-cfs__step-val" v-if="form_sequence == 'datetime_selection' && (is_staffmember_activated == 1 || ( 'undefined' != typeof is_location_activated && '1' == is_location_activated ) )"><?php esc_html_e('Date & Time Selection', 'bookingpress-appointment-booking'); ?></div>
                                                                </div>
                                    ...
                                    <?php do_action('bookingpress_captcha_setting_after'); ?>
                                    <div class="bpa-cs-sp-sub-module--separator"></div>
                                    <div class="bpa-cs-sp-sub-module bpa-cs-sp--form-controls">
                                        <div class="bpa-sm--item">
                                    ...
                                    <div class="bpa-cs-sp-sub-module bpa-cs-sp--form-controls" v-if="is_staffmember_activated == '1'">
                                        ...
                                        <div class="bpa-sm--item --bpa-is-flexbox">
                                            ...
                                            <!-- <el-switch v-model="booking_form_settings.hide_staffmember_selection" class="bpa-swtich-control" @change="bookingpress_after_change_position" :disabled="hide_staff_step_disabled"></el-switch> -->
                                            <el-tooltip class="item" effect="dark" content="" placement="top" v-if="hide_staff_step_disabled === true">
                                            <template #content>
                                                <span><?php esc_html_e('The Staff Member step cannot be hidden once it has been set after the Date & Time step.', 'bookingpress-appointment-booking'); ?></span>
                                            </template>
                                            <el-switch v-model="booking_form_settings.hide_staffmember_selection" class="bpa-swtich-control" :disabled="hide_staff_step_disabled"></el-switch>
                                            </el-tooltip>
                                            <template v-else>
                                            <el-switch v-model="booking_form_settings.hide_staffmember_selection" class="bpa-swtich-control" :disabled="hide_staff_step_disabled" @change="bookingpress_after_change_position"></el-switch>
                                            </template>
                                        </div>
                                        <div class="bpa-sm--item">
                                            <el-row type="flex" class="bpa-customize-lp-field"> 
                            ...
                            <el-col :xs="4" :sm="4" :md="4" :lg="4" :xl="4">
                                <div class="bpa-customize-step-side-panel">
                                    ...
                                    <div class="bpa-cs-sp-sub-module bpa-cs-sp--form-controls">
                                        ...
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('File Upload max limit reached message', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="tab_container_data.fileupload_max_limit_reach_msg" class="bpa-form-control"></el-input>
                                        </div>
                                        <?php
                                        ...
                                        <h5 class="bpa-sm-sub-heading--item"><?php esc_html_e('Popup Form Labels', 'bookingpress-appointment-booking'); ?></h5>
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Booking form popup button title', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="front_label_edit_data.bookingpress_popup_btn_title" class="bpa-form-control"></el-input>
                                        </div>
                        ...
                        <el-row type="flex">
                            <el-col :xs="4" :sm="4" :md="4" :lg="4" :xl="4">
                                <div class="bpa-customize-step-side-panel">
                                    ...
                                    <div class="bpa-cs-sp-sub-module bpa-cs-sp--form-controls" >
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label" style="max-width:100%"><?php esc_html_e('Field used for authentication', 'bookingpress-appointment-booking'); ?></label>
                                            <el-select v-model="my_booking_field_settings.auth_field" class="bpa-form-control" popper-class="bpa-el-select--is-with-navbar">
                                                <el-option label="<?php esc_html_e('Username / Email Address', 'bookingpress-appointment-booking'); ?>" value="email_address"><?php esc_html_e('Username / Email Address', 'bookingpress-appointment-booking'); ?></el-option>
                                                <el-option label="<?php esc_html_e('Phone Number', 'bookingpress-appointment-booking'); ?>" value="phone_number"><?php esc_html_e('Phone Number', 'bookingpress-appointment-booking'); ?></el-option>
                                            </el-select>
                                        </div>                                       
                                    </div>
                                    <div class="bpa-cs-sp-sub-module bpa-cs-sp--form-controls">                                        
                            ...
                            <el-col :xs="4" :sm="4" :md="4" :lg="4" :xl="4">
                                <div class="bpa-customize-step-side-panel">
                                    ...
                                    <div class="bpa-cs-sp-sub-module bpa-cs-sp--form-controls">       
                                        ...
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Phone Number field label', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.login_form_phone_number_field_label" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Phone Number field Placeholder', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.login_form_phone_number_field_placeholder" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">
                                        ...
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Phone Number required field label', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.login_form_phone_number_required_field_label" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">
                                        ...
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Cancellation Reason Title', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.cancellation_reason_title" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">
