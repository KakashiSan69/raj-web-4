...
<el-main class="bpa-main-listing-card-container bpa-default-card bpa-staff-edit-profile-container bpa--is-page-non-scrollable-mob" :class="(bookingpress_staff_customize_view == 1 ) ? 'bpa-main-list-card__is-staff-custom-view':''" id="all-page-main-container">
	...
	<div id="bpa-main-container">
		<div class="bpa-sep--body-content">
					...
					<template>
						<div class="bpa-form-body-row">
							...
							<el-row :gutter="32">
								...
								<?php do_action("bookingpress_staff_member_my_profile_form_column"); ?>
							</el-row>									
						</div>
					</template>
				</el-form>
			...
			if ( false == $show_integration_section ** $bpa_manage_calendar_integrations  && ( is_plugin_active( 'bookingpress-zoom/bookingpress-zoom.php' ) || is_plugin_active( 'bookingpress-outlook-calendar/bookingpress-outlook-calendar.php' ) || is_plugin_active( 'bookingpress-google-calendar/bookingpress-google-calendar.php' ) ) )  {
