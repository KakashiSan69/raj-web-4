           ...
           <el-collapse-item :class="(appointment_formdata.bookingpress_total_popover_appointemnt == 1) ? 'bpa-fc-item-accordion-expanded' : ''" v-for="item in appointment_formdata.bookingpress_appointment_popover_data" :name="item.bookingpress_appointment_booking_id" :key="item.bookingpress_appointment_booking_id">
                ...
                <div class="bpa-fc-item__expand-card">
                    <div class="bpa-iec__body">
						...
						<?php do_action('bookingpress_backend_calendar_appointment_detail_after_user_detail'); ?>
                        <div class="bpa-iec__action-btns">
                            ...
                            <?php if ( $BookingPressPro->bookingpress_check_capability( 'bookingpress_edit_appointments' ) ) { ?>
								<el-button v-if="item.bookingpress_app_is_past==false || item.is_allow_edit_past_appointment==1" @click.native.prevent="editAppointmentData(item.bookingpress_appointment_booking_id,'', 'calendar_popover')" class="bpa-btn bpa-btn__small bpa-btn--full-width bpa-btn__filled-light"> 
							...
							<template>								
								<div class="bpa-form-body-row">
									<el-row :gutter="32">
										...
										<el-col v-if="is_staff_enable == 1 && ((typeof allow_multi_staffmember != 'undefined' && allow_multi_staffmember == '0') || (typeof allow_multi_staffmember == 'undefined'))" :xs="24" :sm="24" :md="24" :lg="8" :xl="8">
										...
										<el-col :xs="24" :sm="24" :md="24" :lg="8" :xl="8" v-if="is_bring_anyone_with_you_enable == 1">
											<el-form-item>
												...
												<el-input-number v-model="appointment_formdata.selected_bring_members" class="bpa-form-control bpa-form-control--number" :min="appointment_formdata.bookingpress_bring_anyone_min_capacity" :max="appointment_formdata.bookingpress_bring_anyone_max_capacity" @change="bookingpress_change_bring_anyone()" step-strictly :disabled="typeof appointment_formdata.is_allow_edit_past_appointment != 'undefined' && appointment_formdata.is_allow_edit_past_appointment === 1"></el-input-number>
											</el-form-item> 
										</el-col>
									...
									<el-row :gutter="32">
										<el-col class="bpa-custom-time-row" :xs="24" :sm="24" :md="24" :lg="8" :xl="8">
                                            <el-form-item>
                                                ...
                                                <label class="bpa-form-label bpa-custom-checkbox--is-label"> <el-checkbox v-model="appointment_formdata.appointment_custom_timing" @change="handleCustomTimingChange($event)" :disabled="typeof appointment_formdata.is_allow_edit_past_appointment != 'undefined' && appointment_formdata.is_allow_edit_past_appointment === 1"></el-checkbox> <?php esc_html_e('Allow Custom Duration', 'bookingpress-appointment-booking'); ?></label>
                                            </el-form-item>
                                        </el-col>
									</el-row>
									<el-row :gutter="32">
										<el-col :xs="24" :sm="24" :md="24" :lg="8" :xl="8" v-if="appointment_formdata.appointment_custom_timing == true">
                                            <el-form-item prop="appointment_booked_date">
												...
												<el-date-picker class="bpa-form-control bpa-form-control--date-picker" type="date" :format="bpa_date_common_date_format" :picker-options="filter_pickerOptions" v-model="appointment_formdata.appointment_booked_date" name="appointment_booked_date" popper-class="bpa-el-datepicker-widget-wrapper" type="date" :clearable="false" @change="select_appointment_booking_date($event)" value-format="yyyy-MM-dd" :disabled="typeof appointment_formdata.is_allow_edit_past_appointment != 'undefined' && appointment_formdata.is_allow_edit_past_appointment === 1"></el-date-picker>
                                            </el-form-item>
                                        </el-col>
										...
										<el-col :xs="24" :sm="24" :md="24" :lg="8" :xl="8" v-if="appointment_formdata.appointment_custom_timing == false">
											<el-form-item prop="appointment_booked_date">
												...
												<el-date-picker class="bpa-form-control bpa-form-control--date-picker" :format="bpa_date_common_date_format" v-model="appointment_formdata.appointment_booked_date" name="appointment_booked_date" type="date" :clearable="false" :picker-options="pickerOptions" @change="select_appointment_booking_date($event)" popper-class="bpa-el-select--is-with-modal bpa-el-datepicker-widget-wrapper" value-format="yyyy-MM-dd" :disabled="typeof appointment_formdata.is_allow_edit_past_appointment != 'undefined' && appointment_formdata.is_allow_edit_past_appointment === 1"></el-date-picker>
											</el-form-item>
										</el-col>
										...
										<el-col :xs="24" :sm="24" :md="24" :lg="8" :xl="8">
                                            ...
                                            <el-select class="bpa-form-control" v-model="appointment_formdata.appointment_status" popper-class="bpa-el-select--is-with-modal" :disabled="typeof appointment_formdata.is_allow_edit_past_appointment != 'undefined' && appointment_formdata.is_allow_edit_past_appointment === 1">
											...
											<div v-if="form_fields.is_separator == false">
												...
												<div v-else>
													...
													<el-form-item v-if='form_fields.bookingpress_field_type == "dropdown"' :prop="form_fields.bookingpress_field_meta_key">
														...
														<el-select class="bpa-form-control" :placeholder="form_fields.bookingpress_field_placeholder" v-model="appointment_formdata.bookingpress_appointment_meta_fields_value[form_fields.bookingpress_field_meta_key]" @change="bookingpress_handle_tax_calculation(form_fields.bookingpress_form_field_id, $event, form_fields)">
															<el-option v-for="sel_data in JSON.parse(form_fields.bookingpress_field_values, form_fields)" :key="sel_data.value" :label="sel_data.label" :value="sel_data.value"></el-option>
														</el-select>
													</el-form-item>
						...
						<div class="bpa-aaf--payment-details">
							...
							<div class="bpa-aaf-pd__mark-paid-checkbox" v-if="(appointment_formdata.appointment_update_id == '')">
								<div>
									...
									<el-radio v-model="appointment_formdata.complete_payment_url_selection" label="send_payment_link" @change="handleMarkAsPaid_calendar( $event )"><?php esc_html_e( 'Send Payment Link', 'bookingpress-appointment-booking' ); ?></el-radio>
									<el-radio v-model="appointment_formdata.complete_payment_url_selection" label="mark_as_paid" @change="handleMarkAsPaid_calendar( $event )"><?php esc_html_e( 'Mark as paid', 'bookingpress-appointment-booking' ); ?></el-radio>
									<el-radio v-model="appointment_formdata.complete_payment_url_selection" label="do_nothing" @change="handleMarkAsPaid_calendar( $event )"><?php esc_html_e( 'Do Nothing', 'bookingpress-appointment-booking' ); ?></el-radio>
									<el-radio v-model="appointment_formdata.complete_payment_url_selection" label="mark_as_pending" @change="handleMarkAsPaid_calendar( $event )"><?php esc_html_e( 'Mark as pending', 'bookingpress-appointment-booking' ); ?></el-radio>
								</div>
