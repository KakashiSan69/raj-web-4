							...
							<div class="bpa-ai-btns">
								<el-row type="flex">
									<el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
										<el-button class="bpa-btn bpa-btn--primary bpa-btn--full-width" @click="bookingpress_activate_addon(addons.key)" :class="typeof is_display_activate_loader !== 'undefined' && is_display_activate_loader  == addons.key ? 'bpa-btn--is-loader' : ''" :id="`activate-${addons.key}`" :disabled="is_disabled_activate == addons.key ? true : false" v-if="addons.is_active == ''" >
						...
						<el-col :xs="12" :sm="12" :md="12" :lg="8" :xl="6"  v-for="addons in addonsList" class="bpa-addons-items-col">
							<div class="bpa-addon-item" :id="addons.addon_key+'_activate_addon'">
								...
								<div class="bpa-ai-btns">
									...
									<el-row type="flex">
										<el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
											<el-button class="bpa-btn bpa-btn--primary bpa-btn--full-width" @click="bookingpress_activate_plugin(addons.addon_installer, addons.addon_key, addons.addon_name, (addons.addon_incompatibility || []) )" :class="typeof is_display_activate_loader !== 'undefined' && is_display_activate_loader == addons.addon_installer ? 'bpa-btn--is-loader' : ''"  :disabled="is_disabled_activate == addons.addon_installer ? true : false" :id="`activate-${addons.addon_key}`" v-if="addons.addon_isactive == '0'" >
												<span class="bpa-btn__label"><?php esc_html_e( 'Activate', 'bookingpress-appointment-booking' ); ?></span>
												<div class="bpa-btn--loader__circles">
													<div></div>
													<div></div>
