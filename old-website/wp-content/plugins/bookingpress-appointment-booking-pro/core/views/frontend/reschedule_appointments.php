		...
		<div class="bpa-reschedule-shortcode-container">
			...
			<div v-if="is_success_msg == ''" class="bpa-reschedule-form-data">
				<div class="bpa-front-reschedule-heading">
					<div class="bpa-front-module-heading" aria-label="<?php echo esc_html($reschedule_popup_title); ?>"><?php echo esc_html($reschedule_popup_title); ?></div>
					<div class="bpa-front-cp-rd__desc" aria-label="<?php echo esc_html($reschedule_popup_description); ?>"><?php echo esc_html($reschedule_popup_description); ?></div>
				</div>			
				<el-form @submit.native.prevent :model="bookingpress_mybooking_rescheduling_form" ref="bookingpress_mybooking_rescheduling_form" :rules="bookingpress_mybooking_rescheduling_form_rules">
					<template slot-scope="scope">								
							...
							<el-row :gutter="32">
								<el-col :xs="24" :sm="24" :md="24" :lg="12" :xl="12">
									<el-form-item prop="appointment_booked_date">
										<template #label>
											<span class="bpa-front-form-label" aria-label="<?php echo esc_html($bookingpress_customize_settings_details['reschedule_date_label']); ?>"><?php echo esc_html($bookingpress_customize_settings_details['reschedule_date_label']); ?></span>
										</template>
								...
								<el-col :xs="24" :sm="24" :md="24" :lg="12" :xl="12" v-if="reschedule_appointment_service_duration_unit !='d'">
									<el-form-item prop="appointment_customer_reschedule_booked_time">
										<template #label>
											<span class="bpa-front-form-label" aria-label="<?php echo esc_html($bookingpress_customize_settings_details['reschedule_time_label']); ?>"><?php echo esc_html($bookingpress_customize_settings_details['reschedule_time_label']); ?></span>
										</template>
						...
						<div class="bpa-front-reschedule-footer">						
							<el-button id="bookingpress_book_appointment_btn" class="bpa-front-btn bpa-front-btn__medium bpa-front-btn--primary bpa_focusable" @click="RescheduleAppointmentShortcode(reschedule_apt_status)" :class="(is_rescheduled_loader == true || customer_reschedule_appointment_loader) ? 'bpa-front-btn--is-loader' : ''" :disabled="(is_rescheduled_loader || customer_reschedule_appointment_loader)" aria-label="<?php echo esc_html($bookingpress_customize_settings_details['reschedule_update_btn_label']); ?>">	
