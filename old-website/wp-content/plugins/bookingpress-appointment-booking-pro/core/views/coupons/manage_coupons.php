...
<el-main class="bpa-main-listing-card-container bpa-default-card bpa--is-page-scrollable-tablet" id="all-page-main-container" :class="(bookingpress_staff_customize_view == 1 ) ? 'bpa-main-list-card__is-staff-custom-view':''">
	...
	<el-row type="flex" class="bpa-mlc-head-wrap">
		...
		<el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12">
			<div class="bpa-hw-right-btn-group">
				<el-button class="bpa-btn bpa-btn--primary" @click="openCouponModal" v-if="save_coupon_details == 1">
	...
	<div id="bpa-main-container">
					...
					<el-table ref="multipleTable" :data="items" @selection-change="handleSelectionChange" class="bpa-tc__coupons-module" :row-class-name="bookingpress_row_classname">
						...
						<el-table-column prop="coupon_total_used" label="<?php esc_html_e( 'Usages', 'bookingpress-appointment-booking' ); ?>">
							<template slot-scope="scope">
								...
								<div class="bpa-table-actions-wrap" v-if="change_coupon_status == 1 || get_edit_coupon_details == 1 || delete_coupons == 1">
									<div class="bpa-table-actions">
										<el-tooltip effect="dark" content="" placement="top" open-delay="300" v-if="scope.row.coupon_status == false && change_coupon_status == 1">
											<div slot="content">
										...
										<el-tooltip effect="dark" content="" placement="top" open-delay="300" v-if="scope.row.coupon_status == true && change_coupon_status == 1">
											<div slot="content">
										...
										<el-tooltip effect="dark" content="" placement="top" open-delay="300" v-if="get_edit_coupon_details == 1">
											<div slot="content">
										...
										<el-tooltip effect="dark" content="" placement="top" open-delay="300" v-if="delete_coupons == 1">
											<div slot="content">
		...
		<el-row class="bpa-pagination" type="flex" v-if="items.length > 0"> <!-- Pagination -->
			...
			<el-container v-if="multipleSelection.length > 0 && bulk_coupon_actions == 1" class="bpa-default-card bpa-bulk-actions-card">
								...
								<template>
									<div class="bpa-form-body-row">
										<el-row :gutter="32">
											...
											<el-col :xs="24" :sm="24" :md="24" :lg="12" :xl="8">
												<el-form-item prop="coupon_allowed_customer">
													<template #label>
														<span class="bpa-form-label"><?php esc_html_e( 'Select Customer', 'bookingpress-appointment-booking' ); ?></span>
													</template>
													<el-select class="bpa-form-control" name="coupon_allowed_customer" multiple v-model="coupon_details.coupon_allowed_customer" filterable placeholder="<?php esc_html_e( 'Start typing to fetch customer', 'bookingpress-appointment-booking' ); ?>" remote reserve-keyword :remote-method="bookingpress_get_customer_list" :loading="bookingpress_customer_loading"  popper-class="bpa-el-select--is-with-modal" v-cancel-read-only >
														<el-option v-for="item in coupon_customers_list" :key="item.value" :label="item.text" :value="item.value">
															<span>{{ item.text }}</span>
														</el-option>
													</el-select>   
												</el-form-item>
